...
import { 
  ...
  Search, Command, Home, Plus, Moon, Sun, ArrowRight, FileText
} from 'lucide-react';
        ...
        <AnimatePresence>
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-start justify-center pt-[20vh] px-4">
                    ...
                    />
                    <motion.div
                        className="w-full max-w-[600px] bg-[#fafafa]/95 dark:bg-gray-900/80 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden relative z-10 border border-gray-100 dark:border-white/10 flex flex-col max-h-[60vh] ring-1 ring-black/5"
        ...
        <AnimatePresence>
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    />
                    <motion.div
                        className="w-full max-w-[800px] h-[600px] bg-[#fafafa]/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden relative z-10 border border-gray-100 dark:border-white/10 flex flex-col md:flex-row"
                                 ...
                                 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                     {filteredTemplates.map(template => {
                                         ...
                                         <div
                                            ...
                                            className={`relative group p-4 rounded-xl border transition-all cursor-pointer flex flex-col gap-3 hover:shadow-lg ${
                                                isSelected
